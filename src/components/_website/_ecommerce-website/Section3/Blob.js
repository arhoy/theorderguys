  ...
  return (
    <Container>
      ...
      <SubContainer>
        <UL>
          <li>
            <GitHubIcon /> Integrate with Existing Site
          </li>
          <li>
            <BitbucketIcon /> Longer Set Depending on requirements
          </li>
          <li>
            <GitlabIcon /> CMS or Stripe Button Only
          </li>
          <li>
            <GitlabIcon /> Smaller Inventory Under 1000 products
          </li>
        </UL>
      </SubContainer>
    </Container>

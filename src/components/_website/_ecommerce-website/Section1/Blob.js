...
export const Blob = () => {
  return (
    <Container>
      <TitleContainer>
        <Title> Simple but Effective Ecommerce Stores</Title>
      </TitleContainer>

      <SubContainer>
        <UL>
          <li>
            <GitHubIcon /> Inexpensive
          </li>
          <li>
            <BitbucketIcon /> Fast Setup
          </li>
          <li>
            <GitlabIcon /> Limited theme customizations
          </li>
          <li>
            <GitlabIcon /> No Platform Fees
          </li>
        </UL>
      </SubContainer>
    </Container>

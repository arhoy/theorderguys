...
export const OurExtras2 = () => {
  return (
    <Container>
      ...
      <p>
        {' '}
        Google By Business Optimization is a key component to local SEO. We will
        make a couple changes each month as we see fit to ensure that your local
        SEO gets optimized.
      </p>
      <br />
      <p>
      ...
      <p>* Minimum Ad Budget at least $150/month</p>
    </Container>
  );
};

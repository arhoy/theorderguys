    ...
    <Layout>
      ...
      <Section>
        ...
        <CustomP>
          ...
          using the following technologies: - “Cookies” are data files that are
          ...
          disable cookies, visit http://www.allaboutcookies.org. - “Log files”
        ...
        <CustomP>
          ...
          are talking both about Device Information and Order Information. HOW
          DO WE USE YOUR PERSONAL INFORMATION? We use the Order Information that
        ...
        <CustomP>
          ...
          Alliance’s opt-out portal at: http://optout.aboutads.info/. DO NOT
          TRACK Please note that we do not alter our Site’s data collection and
        ...
        <CustomP>
          ...
          ask us to delete this information. CHANGES We may update this privacy
          policy from time to time in order to reflect, for example, changes to
          our practices or for other operational, legal or regulatory reasons.
          We may also collect data through user forms for the purpose of serving
          your content may be related to your interests and the content of our
          site
        </CustomP>
        <CustomP>
